...
## "musl" is specified, the table for "wcwidth" of musl C library is used.
## When "auto" is specified, the character width mode is automatically selected
## based on interactions with the terminal.
...
ble-face -s argument_error            fg=#B3A97E,bg=#5D0010 #66000C
ble-face -s argument_option           fg=#B3A97E #B5A978
ble-face -s auto_complete             fg=#484D52,bg=black #474D53
ble-face -s command_alias             fg=#00C08E #00C48A
ble-face -s command_builtin           fg=#7B59E2 #8157EA
ble-face -s command_builtin_dot       fg=#7B59E2,bold
ble-face -s command_directory         fg=#6880FF
ble-face -s command_file              fg=#5395F9 #3797FF
ble-face -s command_function          fg=#2F66FF #0F68FF
ble-face -s command_jobs              fg=#6DCA40,bold #42CD14
ble-face -s command_keyword           fg=#2F66FF #0F68FF
ble-face -s disabled                  fg=#484D52 #474D53
ble-face -s filename_block            fg=#C3B11A #C7B000
ble-face -s filename_character        fg=#C6C8CB
ble-face -s filename_directory        fg=#6880FF
ble-face -s filename_directory_sticky fg=#C6C8CB,bg=#6880FF #C6C8CB
ble-face -s filename_executable       fg=#6DCA40 #42CD14
ble-face -s filename_link             fg=#ACCBE1 #A4CCE3
ble-face -s filename_ls_colors        underline
ble-face -s filename_orphan           fg=#ACCBE1,bg=#66A8A4 #A4CCE3 #4DAAA5
ble-face -s filename_other            fg=#C6C8CB
ble-face -s filename_pipe             fg=#0B5096 #00529B
ble-face -s filename_setgid           fg=#0B0B0C,bg=191
ble-face -s filename_setuid           fg=#0B0B0C,bg=220
ble-face -s filename_socket           fg=#10A3D2 #00A6D7
ble-face -s filename_url              fg=#56C636 #00C900
ble-face -s filename_warning          fg=#E3D888 #E5D87C
#ble-face -s menu_filter_fixed         bold
#ble-face -s menu_filter_input         fg=16,bg=229
ble-face -s overwrite_mode            fg=#0B0B0C,bg=51
#ble-face -s prompt_status_line        fg=231,bg=240
ble-face -s region                    fg=#C6C8CB,bg=60
ble-face -s region_insert             fg=#6C6F7F #6B6F80
ble-face -s region_match              fg=#C6C8CB,bg=55
ble-face -s region_target             fg=#0B0B0C,bg=153
ble-face -s syntax_brace              fg=#00B2B1 #00B5B2
ble-face -s syntax_command            fg=#733823 #7C341D
ble-face -s syntax_comment            fg=#6C6F7F #6B6F80
ble-face -s syntax_default            none
ble-face -s syntax_delimiter          fg=#D1D0A3 #D1D09E
ble-face -s syntax_document           fg=#8E5D00 #965A00
ble-face -s syntax_document_begin     fg=#8E5D00,bold
ble-face -s syntax_error              fg=#C00000
ble-face -s syntax_escape             fg=#FFE787 #FFE677
ble-face -s syntax_expr               fg=#538800 #408A00
ble-face -s syntax_function_name      fg=#2F66FF #0F68FF
ble-face -s syntax_glob               fg=#921B72 #A00075
ble-face -s syntax_history_expansion  bg=94,fg=231
ble-face -s syntax_param_expansion    fg=#FFE787 #FFE677
ble-face -s syntax_quotation          fg=#6DCA40 #42CD14
ble-face -s syntax_quoted             fg=#6DCA40 #42CD14
ble-face -s syntax_tilde              fg=#6880FF
ble-face -s syntax_varname            fg=#D1D0A3 #D1D09E
ble-face -s varname_array             fg=#D75F00 #E85500
ble-face -s varname_empty             fg=#C6C8CB
ble-face -s varname_export            fg=#75B3A5,bold #60B5A5
ble-face -s varname_expr              fg=#B37EB0 #BC7BB3
ble-face -s varname_hash              fg=#223B66 #193C69
ble-face -s varname_number            fg=#538800 #408A00
ble-face -s varname_readonly          fg=#75B3A5 #60B5A5
ble-face -s varname_transform         fg=29,bold
ble-face -s varname_unset             fg=#C00000 #D20000
ble-face -s vbell                     fg=#6C6F7F,bg=#242629
ble-face -s vbell_erase               bg=#0B0B0C
ble-face -s vbell_flash               fg=#6C6F7F,reverse
